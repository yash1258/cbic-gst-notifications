"""
Splits the large `raw_metadata.json` into isolated year.json files for Circulars.
"""
...
class GstCircularOrganizer:
    ...
    def run(self):
        ...
        print(f"Organizing {len(circulars)} records by year...")

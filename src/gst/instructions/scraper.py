"""
Scrapes metadata from the CBIC GST Instructions endpoint.
"""
...
class GstInstructionScraper:
    ...
    async def run(self):
        ...
        print(f"Scanning GST Instruction APIs: IDs {start_id:,} to {END_ID:,}")
        ...
        save_json(self.raw_file, all_instructions)
        save_json(self.err_file, all_errors)
        print(f"API Metadata scrape complete. {len(all_instructions)} GST instructions found.")

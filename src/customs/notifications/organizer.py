"""
Splits raw_metadata.json into isolated year.json files for Customs Notifications.
"""
...
class CustomsNotificationOrganizer:
    def __init__(self):
    ...
    def run(self):
        ...
        print(f"Organizing {len(notifications)} Customs notification records by year...")

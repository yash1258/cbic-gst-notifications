"""
Scrapes metadata from the CBIC Customs Circulars endpoints.
"""
...
class CustomsCircularScraper:
    ...
    async def run(self):
        ...
        print(f"Scanning Customs Circular APIs: IDs {start_id:,} to {END_ID:,}")
        ...
        save_json(self.raw_file, all_circulars)
        save_json(self.err_file, all_errors)
        print(f"API Metadata scrape complete. {len(all_circulars)} Customs circulars found.")
